...
16) **Ridge Regression with Least Squares**: Ridge regression is an extension of linear regression in which a pentaly term is included in the loss function. This penatly term is called regularization term. Ridge regression is especially useful when dats points are noisy and/or having outliers. It also shows robustness against overfitting.